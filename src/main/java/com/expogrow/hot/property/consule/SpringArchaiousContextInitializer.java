...
@Log4j2
public class SpringArchaiousContextInitializer
	...
	public void initialize(final ConfigurableApplicationContext applicationContext) {
		...
		final SpringArchaiusPropertySource another = new SpringArchaiusPropertySource("consul-dynamic");

		propertySources.addFirst(another);
